...
(function() {
    ...
    // Your code here...
    const scriptsToLoad = [
    "http://127.0.0.1:8000/static/js/jquery/jquery-3.3.1.min.js",
    "http://127.0.0.1:8000/static/js/ime/libs/rangy/rangy-core.js",
    "http://127.0.0.1:8000/static/js/ime/src/jquery.ime.js",
    "http://127.0.0.1:8000/static/js/ime/src/jquery.ime.preferences.js",
    "http://127.0.0.1:8000/static/js/ime/src/jquery.ime.inputmethods.js",
    "http://127.0.0.1:8000/static/js/caret-position.js",
    "http://127.0.0.1:8000/static/js/translator.js"
    ];

    const stylesToLoad = [
        "http://127.0.0.1:8000/static/css/inputtools.css"
    ];
    ...
    var inputtools = {
        ...
        registerIME: function() {
            ...
            $.ime.setPath( 'http://127.0.0.1:8000/static/js/ime/');
    ...
    function insertWrapperDiv(){
        let obj = document.getElementById('body');
        let parent = obj.closest('table');
        var divbox = document.createElement("div");
        divbox.setAttribute("class", "translator-wrapper");
        divbox.setAttribute("id", "translatorWrapper");
        parent.parentNode.insertBefore(divbox, parent);
    }
